// NOTICE: Integration with Artemis
//
// The default loader on this file is not compatible with Webpack. When
// upgrading, the library must be manually fixed by removing the `if/else`
// logic in the first function.
//
// In other words, take the first section of the code:
//
//   !function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).EasyMDE=e()}}
// 
// And remove the if/else statements, keeping only the contents of the final `else` statement.
// 
// It should now look like:
//
//   !function(e){("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).EasyMDE=e()}
//
