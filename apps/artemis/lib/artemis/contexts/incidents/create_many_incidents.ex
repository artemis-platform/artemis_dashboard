defmodule Artemis.CreateManyIncidents do
  ...
  def call(params, user) do
    with_transaction(fn () ->
      params
      |> insert_records
      |> Event.broadcast("incidents:created:many", user)
    end)
  end
  ...
  defp insert_records(params) do
    ...
    case Repo.insert_all(Incident, params, conflict_target: conflict_target, on_conflict: on_conflict) do
      {0, _} -> {:error, "No records created"}
